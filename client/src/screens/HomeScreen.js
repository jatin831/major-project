        ...
        <div>
            ...
            <div className="homepage-container">
                <Grid container
                    ...
                    <Grid item xs={7} style={{ backgroundColor: "white", borderRadius: "25px" }}>
                        <Grid spacing={3}>
                            {/* <Grid item xs={12}>
                                <h3>Are you a</h3>
                            </Grid> */}
                            <Grid item xs={12}>
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <Grid container >
                                            <Grid item xs={12}>
                                                <img src={ManufacturerImage} height={150} width={150}></img>
                                            </Grid>
                                            <Grid item xs={12}>
                                    ...
                                    <Grid item xs={6}>
                                        <Grid container>
                                            <Grid item xs={12}>
                                                <img src={DistributorImage} height={150} width={180}></img>
                                            </Grid>
                                            <Grid item xs={12}>
                                                <Button variant="contained" color="primary">
                                                    Distributor
                                    ...
                                    <Grid item xs={6}>
                                        <Grid container>
                                            <Grid item xs={12}>
                                                <img src={VaccinationCenterImage} height={150} width={150}></img>
                                            </Grid>
                                            <Grid item xs={12}>
                                                <Button variant="contained" color="primary">
                                                    Vaccination Center
